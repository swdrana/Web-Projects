...
import sectionCureveBG from "./../../assets/images/bg/section-curve.png";
// const AnimationBG = styled.div`
//   height: 120px;
//   background: url(${sectionCureveBG}) repeat-x;
...
const Footer = () => {
  return (
    <div className="pb-8 md:pb-14 lg:pb-0 relative bg-gray-white">
      ...
      <div className={`h-[120px] animate-left-to-right-scroll`} style={{ backgroundImage: `url(${sectionCureveBG})` }}/>
      <footer className="footer justify-between p-10 bg-[#191D28] text-white">
        ...
        <div>
          ...
          <Link to="https://www.facebook.com/sheraorganicshop">
            {" "}
            facebook.com/sheraorganicshop{" "}
          </Link>
        </div>
      </footer>
      <footer className="footer  justify-between  px-10 py-4 border-t bg-[#191D28] items-center  text-white border-base-300">
        <div className="items-center grid-flow-col">
          <p>©2019-2023 All Rights Reserved by Mehedi Hasan</p>
        </div>
        <div className="items-center grid-flow-col">
          <Link className="flex items-center w-[100%]">
            <img
              className=" w-16"
